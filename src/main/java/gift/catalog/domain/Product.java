...
public class Product {
    ...
    public static List<String> checkErrors(String name, boolean allowKakao) {
    ...
    private void validate(String name, boolean allowKakao) {
        List<String> errors = checkErrors(name, allowKakao);
        if (!errors.isEmpty()) {

...
public class AdminMemberController {
    ...
    public String list(Model model) {
        model.addAttribute("members", memberService.getAdminMembers());
        return "member/list";
    }
    ...
    public String create(
        ...
        if (memberService.existsByEmail(email)) {
            populateNewFormError(model, email, "회원 이메일이 이미 등록되어 있습니다.");
            return "member/new";
        }

        memberService.createAdminMember(email, password);
    ...
    public String update(
        ...
        memberService.updateAdminMember(id, email, password);
        return "redirect:/admin/members";
    }

...
### [ADR-0001: Testcontainers 기반 테스트 시스템 우선 구축](./0001-testcontainers-based-test-system.md)
...
### [ADR-0002: Gradle check를 품질 게이트 진입점으로 사용](./0002-gradle-check-quality-gate.md)
...
### [ADR-0003: 대규모 리팩토링 전 JaCoCo 커버리지 게이트 우선 도입](./0003-jacoco-before-archunit.md)
